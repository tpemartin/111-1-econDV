augmentData = function(COVIDNationalSum){
  library(dplyr)
  # complete NA
  ...
  return(COVIDNationalSum)
}

plotBenchmark = function(COVIDNationalSum){
  pltCOVID=Plot()
...
plotMorph2 = function(COVIDNationalSum){
  pltCOVID=Plot()
  pltCOVID$ggplot = ggplot(data = COVIDNationalSum)
...
plotMorph3 = function(COVIDNationalSum){
  pltCOVID=Plot()
  pltCOVID$ggplot = ggplot(data = COVIDNationalSum)
...
plotMorph4 = function(COVIDNationalSum){
  pltCOVID=Plot()
  pltCOVID$ggplot = ggplot(data = COVIDNationalSum)
